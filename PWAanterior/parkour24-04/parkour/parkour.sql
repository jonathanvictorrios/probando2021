...
CREATE TABLE `traceur` (
  ...
  `pais_traceur` varchar(150) NOT NULL,
...
INSERT INTO `traceur` (`id_grupo`, `nombre_traceur`, `apellido_traceur`, `pais_traceur`, `fechanacimiento_traceur`, `biografia_traceur`) VALUES
...
INSERT INTO `imagen` (`id_traceur`, `nombre_imagen`, `ruta_image`, `descripcion_imagen`, `nivel_imagen`) VALUES
