...
class Provincia
{
    ...
    {
        $this->suscriptores = $colSuscriptores;
    }
    /**
        ...
        if ($base->Iniciar()) {
            ...
            if ($res > -1) {
                if ($res > 0) {
                    $row = $base->Registro();
                    $objPais = new Pais();
                    $objPais->setIdPais($row['id_pais']);
                    $objPais->cargar();
                    $this->setear($row['id_provincia'],$row['nombre_provincia'],$objPais);
                }
            }
        } else {
        ...
        if ($res > -1) {
            if ($res > 0) {
                while ($row = $base->Registro()) {
                    ...
                    $objPais->setIdPais($row['id_pais']);
                    $objPais->cargar();
                    $obj->setear($row['id_provincia'], $row['nombre_provincia'],$objPais);
