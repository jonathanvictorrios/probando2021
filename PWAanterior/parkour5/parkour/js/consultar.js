...
$('#campoProvincia').on('keyup', function() {
    var paisElegido=$('#campoEstado').val();
    if (this.value != "") {
        $.post("./control/buscarProvincias.php", { caracterProvincia: this.value,paisElegido:paisElegido}, function(data) {
...
$('#grupo').on("change", function() {
    ...
    $.post("control/buscarIntegrantes_copy.php", { idgrupo: this.value }, function(data) {
