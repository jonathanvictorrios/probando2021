...
class Suscriptor
{
     ...
     */
    public function setear($name, $empres, $correo, $contra, $tel, $objProv)
    {
        $this->setNombre($name);
        ...
        if ($base->Iniciar()) {
            ...
            if ($res > -1) {
                if ($res > 0) {
                    ...
                    $objProv->cargar();
                    $this->setear($fila['nombre_suscriptor'], $fila['empresa_suscriptor'], $fila['email_suscriptor'], $fila['contra_suscriptor'], $fila['telefono_suscriptor'], $objProv);
                    $resp = true;
                }
            }
        } else {
